...
static const char *cmds[] = {
	...
	"[36] stop",
	"[37] start",
	"[40] 1 read 0x1018 0 u8",
	"[41] 1 read 0x1018 1 u32",
	"[42] 1 read 0x1018 2 u32",
	"[43] 1 read 0x1018 3 u32",
	"[44] 1 read 0x1018 4 u32",
	"[50] r 0x2001 0 b",
	"[51] w 0x2001 0 b 1",
	"[52] r 0x2001 0 b",
	"[53] r 0x2002 0 i8",
	...
	"[124] r 0x201B 0 u64",
	"[130] write 0x1400 1 u32 0x80000202",
	"[131] write 0x1600 0 u8 0",
	"[132] write 0x1600 1 u32 0x20050008",
	"[133] write 0x1600 2 u32 0x20060010",
	"[134] write 0x1600 3 u32 0x20070020",
	"[135] write 0x1600 0 u8 3",
	"[136] write 0x1400 1 u32 0x202",
	"[137] write 0x1800 1 u32 0x80000182",
	"[138] write 0x1800 2 u8 0x01",
	"[139] write 0x1A00 0 u8 0",
	"[140] write 0x1A00 1 u32 0x20050008",
	"[141] write 0x1A00 2 u32 0x20060010",
	"[142] write 0x1A00 3 u32 0x20070020",
	"[143] write 0x1A00 0 u8 3",
	"[144] write 0x1800 1 u32 0x182",
	"[145] set tpdo 1 0x202 sync1 3 0x2000 0 u8 0x2001 0 u16 0x2002 0 u32",
	"[146] set rpdo 1 0x182 sync0 3 0x2003 0 u8 0x2004 0 u16 0x2005 0 u32",
	"[147] write pdo 1 3 0x12 0x3456 0x789ABCDE",
	"[148] read pdo 1",
};
