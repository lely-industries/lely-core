...
liblely-co requires the Lely C11 and POSIX compatibility library (liblely-libc),
the Lely utilities library (liblely-util), the Lely CAN library (liblely-can)
and, for some of the tools, the Lely I/O library (liblely-io) to be installed.
