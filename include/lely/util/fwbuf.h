 ...
 *              \a pos until the (current) end of the file are mapped. It is not
 *              possible to extend the map beyond the current end of the file.
 *              On success, *\a psize contains the size of the map.
 *
 ...
 * file operation can be obtained with `get_errnum()`.
 *
 * \see fwbuf_clearerr()
 */
