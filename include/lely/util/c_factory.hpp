...
#else
      : m_ctor(factory_find_ctor(name)),
        m_dtor(factory_find_dtor(name))
#endif
  {
  }
...
class c_factory<R*(Args...), U*> : public c_factory<R*, U*>,
...
class c_factory<R*(), U*> : public c_factory<R*, U*>, public factory<U*()> {
 public:
  explicit c_factory(factory_ctor_t* ctor, factory_dtor_t* dtor)
...
class c_factory<R*(T0), U*> : public c_factory<R*, U*>, public factory<U*(T0)> {
 public:
  explicit c_factory(factory_ctor_t* ctor, factory_dtor_t* dtor)
      : c_factory<R*, U*>(ctor, dtor) {}
...
class c_factory<R*(T0, T1), U*> : public c_factory<R*, U*>,
...
class c_factory<R*(T0, T1, T2), U*> : public c_factory<R*, U*>,
...
class c_factory<R*(T0, T1, T2, T3), U*> : public c_factory<R*, U*>,
                                          public factory<U*(T0, T1, T2, T3)> {
 public:
  explicit c_factory(factory_ctor_t* ctor, factory_dtor_t* dtor)
      : c_factory<R*, U*>(ctor, dtor) {}
...
template <class T>
inline void
cpp_factory_dtor(void* ptr) noexcept {
...
#define LELY_C_STATIC_FACTORY(name, ctor, dtor) \
  namespace lely { \
  template <> \
  c_static_factory<ctor, dtor> c_static_factory<ctor, dtor>::instance(name); \
  }

#define LELY_CPP_FACTORY_CTOR_0(R) \
  extern "C" void* lely_cpp_factory_ctor_0_##R(va_list) { \
    return ::lely::cpp_factory_ctor<R>(); \
  }

#define LELY_CPP_FACTORY_CTOR_1(R, T0) \
  extern "C" void* lely_cpp_factory_ctor_1_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    return ::lely::cpp_factory_ctor<R>(t0); \
  }

#define LELY_CPP_FACTORY_CTOR_2(R, T0, T1) \
  extern "C" void* lely_cpp_factory_ctor_2_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
...
#define LELY_CPP_FACTORY_CTOR_3(R, T0, T1, T2) \
  extern "C" void* lely_cpp_factory_ctor_3_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
...
#define LELY_CPP_FACTORY_CTOR_4(R, T0, T1, T2, T3) \
  extern "C" void* lely_cpp_factory_ctor_4_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
...
#define LELY_CPP_FACTORY_CTOR_5(R, T0, T1, T2, T3, T4) \
  extern "C" void* lely_cpp_factory_ctor_5_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
...
#define LELY_CPP_FACTORY_CTOR_6(R, T0, T1, T2, T3, T4, T5) \
  extern "C" void* lely_cpp_factory_ctor_6_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
...
#define LELY_CPP_FACTORY_CTOR_7(R, T0, T1, T2, T3, T4, T5, T6) \
  extern "C" void* lely_cpp_factory_ctor_7_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
...
#define LELY_CPP_FACTORY_CTOR_8(R, T0, T1, T2, T3, T4, T5, T6, T7) \
  extern "C" void* lely_cpp_factory_ctor_8_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
    ...
    T6 t6 = va_arg(ap, T6); \
    T7 t7 = va_arg(ap, T7); \
    return ::lely::cpp_factory_ctor<R>(t0, t1, t2, t3, t4, t5, t6, t7); \
  }

#define LELY_CPP_FACTORY_CTOR_9(R, T0, T1, T2, T3, T4, T5, T6, T7, T8) \
  extern "C" void* lely_cpp_factory_ctor_9_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
    ...
    T7 t7 = va_arg(ap, T7); \
    T8 t8 = va_arg(ap, T8); \
    return ::lely::cpp_factory_ctor<R>(t0, t1, t2, t3, t4, t5, t6, t7, t8); \
  }

#define LELY_CPP_FACTORY_CTOR_10(R, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9) \
  extern "C" void* lely_cpp_factory_ctor_10_##R(va_list ap) { \
    T0 t0 = va_arg(ap, T0); \
    T1 t1 = va_arg(ap, T1); \
    T2 t2 = va_arg(ap, T2); \
    T3 t3 = va_arg(ap, T3); \
...
#define LELY_CPP_FACTORY_DTOR(T) \
  extern "C" void lely_cpp_factory_dtor_##T(void* ptr) { \
