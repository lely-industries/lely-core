...
#undef format_printf__
#define format_printf__(x, y)
#else
 ...
 */
LELY_UTIL_DIAG_INLINE void diag_get_handler(
 ...
 */
LELY_UTIL_DIAG_INLINE void diag_set_handler(
		diag_handler_t *handler, void *handle);
 ...
 */
LELY_UTIL_DIAG_INLINE void diag_at_get_handler(
 ...
 */
LELY_UTIL_DIAG_INLINE void diag_at_set_handler(
 ...
 */
LELY_UTIL_DIAG_INLINE void default_diag_handler(void *handle,
		enum diag_severity severity, int errc, const char *format,
		va_list ap) format_printf__(4, 0);
 ...
 * vsnprintf_diag_at().
 */
LELY_UTIL_DIAG_INLINE void default_diag_at_handler(void *handle,
		enum diag_severity severity, int errc, const struct floc *at,
 ...
 */
LELY_UTIL_DIAG_INLINE void daemon_diag_handler(void *handle,
		enum diag_severity severity, int errc, const char *format,
		va_list ap);
 ...
 * vsnprintf_diag_at().
 */
LELY_UTIL_DIAG_INLINE void daemon_diag_at_handler(void *handle,
		enum diag_severity severity, int errc, const struct floc *at,
 ...
 */
LELY_UTIL_DIAG_INLINE void cmd_diag_handler(void *handle, enum diag_severity severity, int errc,
		const char *format, va_list ap) format_printf__(4, 0);
...
#else
// diagnostic functions are disabled, replace their occurrences with empty
// inline functions.
...
LELY_UTIL_DIAG_INLINE void
diag_set_handler(diag_handler_t *phandler, void *phandle)
{
	(void)phandler;
	(void)phandle;
}
...
LELY_UTIL_DIAG_INLINE void
diag_at_set_handler(diag_at_handler_t *phandler, void *phandle)
{
	(void)phandler;
	(void)phandle;
}
