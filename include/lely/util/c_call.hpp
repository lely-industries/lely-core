 ...
 *
 *     set_func(&c_mem_call<func_t*, C, &C::func>::function, static_cast<void*>(obj))
 *
...
template <class F, class C, typename c_mem_fn<F, C>::type> struct c_mem_call;
...
template <class C, class R, class T0, class T1, class T2, class T3, class T4,
		...
		typename c_mem_fn<
			R (*)(T0, T1, T2, T3, T4, T5, T6, T7, void*), C
		>::type M>
...
template <class C, class R, class T0, class T1, class T2, class T3, class T4,
		...
		typename c_mem_fn<
			R (*)(T0, T1, T2, T3, T4, T5, T6, T7, T8, void*), C
		>::type M>
...
template <class C, class R, class T0, class T1, class T2, class T3, class T4,
		...
		typename c_mem_fn<
			R (*)(T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, void*), C
		>::type M>
