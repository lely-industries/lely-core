...
class LELY_AIO_EXTERN ExecutorBase : public detail::CBase<aio_exec_t> {
 public:
  using CBase::CBase;
...
class LELY_AIO_EXTERN Executor : public ExecutorBase {
 public:
...
class LELY_AIO_EXTERN Task : public aio_task {
 public:
  ...
  ExecutorBase GetExecutor() const noexcept { return ExecutorBase(exec); }
...
class LELY_AIO_EXTERN TaskWrapper : public aio_task {
 public:
  using Signature = void(::std::error_code ec);
