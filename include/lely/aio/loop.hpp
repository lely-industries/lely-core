...
class LELY_AIO_EXTERN LoopBase : public detail::CBase<aio_loop_t> {
 public:
  using CBase::CBase;
  ...
  ::std::size_t RunFor() { return RunUntil(nullptr); }

  ::std::size_t RunFor(::std::error_code& ec) { return RunUntil(nullptr, ec); }
...
class LELY_AIO_EXTERN Loop : public LoopBase {
 public:
  Loop();
