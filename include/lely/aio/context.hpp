...
class LELY_AIO_EXTERN ContextBase : public detail::CBase<aio_context_t> {
 public:
  using CBase::CBase;
...
class LELY_AIO_EXTERN Context : public ContextBase {
 public:
  Context();
...
class LELY_AIO_EXTERN ServiceBase : public detail::CBase<aio_service> {
 public:
  using CBase::CBase;
};

class LELY_AIO_EXTERN BasicService : private aio_service, public ServiceBase {
 public:
 ...
 protected:
  ...
  virtual void NotifyFork(ForkEvent e) { (void)e; }
