...
inline timespec
AbsTime(const ClockType::time_point& abs_time) { return ToTimespec(abs_time); }

template <class Duration>
inline typename ::std::enable_if<
    !::std::is_same<Duration, ClockType::duration>::value, timespec
>::type
...
template <class Clock, class Duration>
inline typename ::std::enable_if<
    !::std::is_same<Clock, ClockType>::value, timespec
>::type
