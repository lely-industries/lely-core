...
#if LELY_AIO_WITH_IOCP
#define AIO_WATCH_INIT(func)	{ (func) }
#else
...
LELY_AIO_EXTERN void *aio_reactor_alloc(void);
LELY_AIO_EXTERN void aio_reactor_free(void *ptr);
LELY_AIO_EXTERN aio_reactor_t *aio_reactor_init(aio_reactor_t *reactor,
		aio_context_t *ctx);
LELY_AIO_EXTERN void aio_reactor_fini(aio_reactor_t *reactor);

LELY_AIO_EXTERN aio_reactor_t *aio_reactor_create(aio_context_t *ctx);
LELY_AIO_EXTERN void aio_reactor_destroy(aio_reactor_t *reactor);

LELY_AIO_REACTOR_INLINE
aio_context_t *aio_reactor_get_context(const aio_reactor_t *reactor)
{
