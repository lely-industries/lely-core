...
public:
	...
	int
	switchSelReq(const co_id& id, co_lss_cs_ind_t* ind, void* data)
			noexcept
	{
	...
	int
	setIdReq(co_unsigned8_t id, co_lss_err_ind_t* ind, void* data)
			noexcept
	{
	...
	int
	setRateReq(co_unsigned16_t rate, co_lss_err_ind_t* ind, void* data)
			noexcept
	{
