...
class LELY_COAPP_EXTERN Node
 ...
 private:
   ...
   */
  virtual void OnCommand(NmtCommand cs) noexcept { (void)cs; }
   ...
   */
  virtual void
  OnRpdo(int num, ::std::error_code ec, const void* p, ::std::size_t n)
      noexcept {
    (void)num;
    (void)ec;
    (void)p;
   ...
   */
  virtual void
  OnTpdo(int num, ::std::error_code ec, const void* p, ::std::size_t n)
      noexcept {
    (void)num;
    (void)ec;
    (void)p;
   ...
   */
  virtual void
  OnSyncError(uint16_t eec, uint8_t er) noexcept { Error(eec, er); }
