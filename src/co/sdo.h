...
#ifndef LELY_CO_INTERN_SDO_H
#define LELY_CO_INTERN_SDO_H
...
#define CO_SDO_INI_SIZE_EXP_GET(cs) \
	(4 - (((cs) & CO_SDO_INI_SIZE_MASK) >> 2))

/*!
 * Sets the SDO size indicator, indicating the expedited transfer of \a n bytes
 * (in the range [1..4]).
 *
...
/*!
 * Sets the SDO size indicator, indicating \a n bytes contain segment data (in
 * the range [0..7]).
 *
