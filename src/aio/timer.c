...
static int aio_clock_realtime_getres(const aio_clock_t *clock,
		struct timespec *res);
static int aio_clock_realtime_gettime(const aio_clock_t *clock,
		struct timespec *tp);
static int aio_clock_realtime_settime(aio_clock_t *clock,
...
LELY_AIO_EXPORT const struct aio_clock_realtime aio_clock_realtime = {
	&aio_clock_realtime_vtbl
};

static int aio_clock_monotonic_getres(const aio_clock_t *clock,
		struct timespec *res);
static int aio_clock_monotonic_gettime(const aio_clock_t *clock,
		struct timespec *tp);
static int aio_clock_monotonic_settime(aio_clock_t *clock,
		const struct timespec *tp);
...
LELY_AIO_EXPORT const struct aio_clock_monotonic aio_clock_monotonic = {
...
aio_timer_async_wait(aio_timer_t *timer, aio_loop_t *loop,
		struct aio_task **ptask)
{
